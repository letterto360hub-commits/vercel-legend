    ...
    <div className="form-container bg-white p-6 rounded-lg shadow-md text-gray-800 w-full">
      ...
      >
        ...
        <label htmlFor="consent" className="leading-snug">
          By submitting this form, I consent to receive communications via WhatsApp,
          SMS, email, phone calls, and other channels, even if my number is registered
          under DND/DNDC. I agree to the {" "} Legendary Builders
          <Link
            href="/privacy-policy"
            target="_blank"
