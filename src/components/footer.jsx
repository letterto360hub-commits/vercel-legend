  ...
  return (
    <section className="bg-[#000D1E] w-full py-6">
      <div className="container mx-auto px-4 grid lg:grid-cols-5 gap-2">
        <Image src={"/images/legendary-logo.png"} width={256} height={234} quality={100} alt="Legendary Logo" className="h-[100px] w-[100px]" />
        ...
        <div className="flex flex-col text-custom gap-6 pt-6">
          <ul className="flex gap-2 items-start flex-col text-xs">
            ...
            <Link href={"https://www.facebook.com/LegendaryBuildr/"} target="_blank">
              <Facebook />
            </Link>
            <Link href={"https://www.instagram.com/legendary.builders/"} target="_blank">
              <Instagram />
            </Link>
            <Link href={"https://twitter.com/LegendaryBuildr"} target="_blank">
              <Twitter />
            </Link>
            <Link href={"https://www.linkedin.com/company/legendary-buildr/"} target="_blank">
              <Linkedin />
            </Link>
            <Link href={"https://www.pinterest.com/Legendarybuildr/"} target="_blank">
              <Pinterest />
            </Link>
          </div>
      ...
      <div className="w-full text-center text-white text-xs py-1 bg-black">&copy; 2025 Legendary Builders
      <p className="text-white text-xs"> Website Designed & Developed by <a href="https://360brandclub.com/" target="_blank">360 BC The Brand Club</a></p>
      </div>
