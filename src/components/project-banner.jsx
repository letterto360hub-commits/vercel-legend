...
export default function ProjectBanner({ data }) {
  ...
  return (
    <section className="w-full relative">
      ...
      <div className="container p-4 mx-auto flex flex-col lg:flex-row gap-6 items-center justify-between bg-white shadow z-10 rounded border-t-4 border-[#CCA557]">
        {data?.banner_strip && (
          <>
            <Image
              src={data.banner_strip.image}
              height={120}
              width={130}
              alt={data.banner_strip.alt}
            />
          ...
          <div className="relative bg-white rounded-lg shadow-lg max-w-3xl w-full mx-4 z-10 overflow-hidden">
            <div className="flex justify-between items-center p-4 border-b">
              <h3 className="text-lg font-semibold">
                Please fill the form to download brochure
              </h3>
              <button
